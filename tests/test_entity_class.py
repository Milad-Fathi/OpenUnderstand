...
def test_class_parent_child_relationship(temp_db):
    ...
    # Create child class - set parent to the parent object
    child = EntityModel.create(
        _name="Dog",
        _kind=class_kind._id,
        _longname="Dog",
        _parent=parent  # Pass the Entity object
    )
    
    # Compare the parent object
    assert child._parent == parent
    
    # Verify parent-child relationship using the parent object
...
def test_class_contains_methods(temp_db):
    ...
    # Create methods - set parent to the Entity object
    EntityModel.create(
        _name="add",
    ...
    # Verify methods belong to class
...
def test_multiple_classes_same_parent(temp_db):
    ...
    # Verify all classes are in the package
...
def test_class_parent_retrieval(temp_db):
    ...
    # Retrieve the parent from child
...
def test_class_interface_implementation(temp_db):
    ...
    circle = EntityModel.create(
        ...
        _kind=class_kind._id,
        _longname="Circle",
        _parent=interface  # Interface is the parent
    )
